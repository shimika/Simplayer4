...
namespace Simplayer4 {
	// Original namespace : WIT.WPF.Samples.WindowResizerExample
	// ref url : blog.witstudio.net/148
	public class WindowResizer {
		...
		protected static void OnResizeDirectionChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) {
			...
			Target.SetBinding(TargetWindowProperty, new Binding() { RelativeSource = new RelativeSource(RelativeSourceMode.FindAncestor, typeof(Window), 1) });
